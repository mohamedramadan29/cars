...
class AgencyRentController extends Controller
{
    use Message_Trait;
    use Upload_Images;
    use Slug_Trait;
    ...
    public function index()
    {
        ...
        return view('admin.AgencyRent.index', compact('agencies'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return view('admin.AgencyRent.add');
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->isMethod('post')) {
            try {
                ...
                if ($request->hasFile('image')) {
                    /////// Delete Old Image
                    $old_image = public_path('assets/uploads/AgencyRent/' . $agency['logo']);
        ...
        return view('admin.AgencyRent.update', compact('agency'));
    }
