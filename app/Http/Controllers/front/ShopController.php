...
class ShopController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return view('front.users.products.add', compact('citizen', 'countries'));
    }
    ...
    public function update(Request $request, $id)
    {
        $citizen = State::all();
        $countries = Country::all();
        $product = shop::with('Country','City')-> where('user_id', Auth::id())->where('id', $id)->first();
        if ($request->isMethod('post')) {
            try {
        ...
        return view('front.users.products.update', compact('citizen', 'product','countries'));
    }
}
