                            ...
                            <div class="card-body">
                                <center><a href="{{ url('auction/details/' . $auction['slug']) }}">
                                        <img class="rounded-circle rent-img"
                                             ...
                                             alt="{{ $auction['name'] }}" /></a>
                                    <h4 class="card-title titlerent"><a href="{{ url('auction/details/' . $auction['slug']) }}"
                                                                        style=""> {{ $auction['name'] }} </a></h4>
                                    <a href="{{ url('auction/details/' . $auction['slug']) }}" class="card-link  gradient-btn">
