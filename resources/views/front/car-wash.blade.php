    ...
    <div id="HomePage">
        <div class="card PageCard">
            <div class="card-body" style="padding:0px;">
                {{-- <h5 class="card-title CT1"><i class="fa fa-car"></i>محطات غسيل السيارات   </h5>
                <h6 class="text-muted desc-textpg"><span style="font-weight: bold;"> هل لديك محطة غسيل  ؟ </span> يمكنك إضافة
                    محطة غسيل معنا وعرضها على موقعنا مجانا </h6>
                <div class="clr"></div>
                    ...
                    @foreach ($washs as $wash)
                        <div class="rgt card cardrepair">
                            <div class="row no-gutters">
                                <div class="col-md-3"><a href="{{ url('car-wash/' . $wash['slug']) }}"><img
                                            src="{{ asset('assets/uploads/WashCars/' . $wash['logo']) }}"
                                            class="repair-img"></a></div>
                                <div class="col-md-9">
                                    <div class="card-body">
                                        <h5 class="card-title"><a href="{{ url('car-wash/' . $wash['slug']) }}">
                                                {{ $wash['name'] }} </a></h5>
                                        <p class="card-text">
                                        <div class="repair-ico"><i class="fas fa-map-marker-alt"></i> المنطقة : <span>
                                                {{ $wash['Country']['name'] }} - {{ $wash['City']['name'] }} <span></div>
                                        <div class="repair-ico"><i class="fas fa-phone"></i>رقم التواصل : <span>
                                                {{ $wash['phone'] }} </span></div>
                                        </p>
                                        <div class="clr"></div>
                                        <a href="tel:{{ $wash['phone'] }}" class="rgt btn btn-success btn-sm"><i
