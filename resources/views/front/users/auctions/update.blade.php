        ...
        <div class="PageCard">
            <div class="card-body" style="padding:0px;">
                ...
                <div class="lft profileLeft">
                    ...
                    <form action="{{ url('user/auction/update/'.$auction['id']) }}" method="post" class="p-form" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                            ...
                            <div class="col-md-12">
                                <select class="custom-select my-1 mr-sm-2 form-control-lg select-form" name="city"
                                    ...
                                    @foreach ($citizen as $city)
                                        <option @if ($city['id'] == $auction['city'])
                                            selected
                            ...
                            <div class="col-md-6">
                                <select class="custom-select my-1 mr-sm-2 form-control-lg select-form" name="car_status">
                                    ...
                                    <option @if($auction['car_status'] == 'مستعملة') selected @endif value="مستعملة"> مستعملة </option>
                                    <option @if($auction['car_status'] == 'جديدة') selected @endif value="جديدة"> جديدة   </option>
                                    <option @if($auction['car_status'] == 'كلاهما') selected @endif value="كلاهما"> كلاهما </option>
                                </select>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="facebook_link" class="form-control form-control-lg input-form"
                                       placeholder=" رابط الفيسبوك" value="{{$auction['facebook_link']}}">
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="instagram_link" class="form-control form-control-lg input-form"
                                       placeholder="رابط انستجرام" value="{{$auction['instagram_link']}}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="{{asset('assets/uploads/Auctions/'.$auction['logo'])}}" width="100px" height="100px" class="img-thumbnail" alt="">
                                </div>
