        ...
        <div class="PageCard">
            <div class="card-body" style="padding:0px;">
                ...
                <div class="lft profileLeft">
                    <h5 class="p-title"><i class="fa fa-bars"></i>  مكاتب تاجير   </h5>
                    <div class="clr"></div>
                    <br>
                    <a href="{{ url('user/rent/add') }}" class="lft btn btn-primary btn-form">
                        <i class="fas fa-edit"></i> اضف مكتب جديد </a>
                    <div class="clr"></div>
                    @if (count($rent) > 0)
                                ...
                                @foreach ($rent as $ren)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('user/rent/update/'.$ren['id'])}}"
