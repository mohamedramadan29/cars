        ...
        <div class="PageCard">
            <div class="card-body" style="padding:0px;">
                ...
                <div class="lft profileLeft">
                    ...
                    <form action="{{url('user/number/update/'.$number['id'])}}" method="post" class="p-form" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img width="100px" height="100px" class="img-thumbnail" src="{{asset('assets/uploads/CarNumbers/'.$number['logo'])}}" alt="">
                                </div>
                            ...
                            <div class="col-md-6">
                                <select class="custom-select my-1 mr-sm-2 form-control-lg select-form" name="city"
                                    ...
                                    @foreach ($citizen as $city)
                                        <option  @if ($city['id'] == $number['city']) selected
