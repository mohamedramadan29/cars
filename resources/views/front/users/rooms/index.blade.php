        ...
        <div class="PageCard">
            <div class="card-body" style="padding:0px;">
                ...
                <div class="lft profileLeft">
                    <h5 class="p-title"><i class="fa fa-bars"></i> المعارض  </h5>
                    <div class="clr"></div>
                    <br>
                    <a href="{{ url('user/room/add') }}" class="lft btn btn-primary btn-form">
                        <i class="fas fa-edit"></i> اضف معرض جديد </a>
                    <div class="clr"></div>
                    @if (count($rooms) > 0)
                                ...
                                @foreach ($rooms as $room)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{url('user/room/update/'.$room['id'])}}"
