        ...
        <div class="PageCard">
            <div class="card-body" style="padding:0px;">
                ...
                <div class="lft profileLeft">
                    <h5 class="p-title"><i class="fas fa-edit"></i> اضافة موضوع جديد </h5>
                    <div class="clr"></div><br>

                    <form action="{{ url('user/forum/add') }}" method="post" class="p-form" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <textarea class="form-control form-control-lg input-form" name="desc" placeholder="الموضوع"></textarea>
                            </div>

                            <div class="col-12">
                                <br>
                                <button type="submit" name="Add" class="rgt btn btn-primary btn-block">  اضف الموضوع 
                                </button>
                            </div>
                        </div>
                    </form>
