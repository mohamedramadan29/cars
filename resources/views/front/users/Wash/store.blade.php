        ...
        <div class="PageCard">
            <div class="card-body" style="padding:0px;">
                ...
                <div class="lft profileLeft">
                    ...
                    <form action="{{ url('user/wash/add') }}" method="post" class="p-form" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <input type="text" name="name" class="form-control form-control-lg input-form"
                                    placeholder="أدخل إسم المحطة " required="">
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-12">
                                <textarea class="form-control form-control-lg" name="desc" rows="2" placeholder="نبذة عن المحطة "></textarea>
                            </div>
                            <div class="col-md-12">
