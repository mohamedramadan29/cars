        ...
        <div class="PageCard">
            <div class="card-body" style="padding:0px;">
                ...
                <div class="lft profileLeft">
                    <h5 class="p-title"><i class="fas fa-edit"></i> اضف محطة غسيل </h5>
                    <div class="clr"></div><br>
                    <form id="uploadForm" action="{{ url('user/wash/add') }}" method="post" class="p-form"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <input required type="text" name="name"
                                    class="form-control form-control-lg input-form" placeholder="أدخل إسم المحطة "
                                    required="">
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-12">
                                <textarea required class="form-control form-control-lg" name="desc" rows="2" placeholder="نبذة عن المحطة "></textarea>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="col-12">
                                ...
                                <button id="submitBtn" type="submit" name="Add"
                                    ...
                                    محطة الغسيل <i class="fa fa-plus"></i></button>
                                <p id="uploadingText"
