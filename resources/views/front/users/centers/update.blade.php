        ...
        <div class="PageCard">
            <div class="card-body" style="padding:0px;">
                ...
                <div class="lft profileLeft">
                    ...
                    <form id="uploadForm" action="{{ url('user/center/update/' . $repair['id']) }}" method="post" class="p-form"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <select required class="custom-select my-1 mr-sm-2 form-control-lg select-form"
                                    ...
                                    @foreach ($countries as $city)
                                        <option @if ($city['id'] == $repair['country']) selected @endif
                            ...
                            <div class="col-md-12">
                                <select required class="custom-select my-1 mr-sm-2 form-control-lg select-form"
                                    ...
                                    <option selected value="{{ $repair['city'] }}">{{ $repair['City']['name'] }}</option>
                                </select>
                            </div>
                            <script>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <br>
                                    <img src="{{ asset('assets/uploads/AutoRepair/' . $repair['logo']) }}" width="100px"
                            ...
                            <div class="col-12">
                                <br>
                                <button id="submitBtn" type="submit" name="Add" class="rgt btn btn-primary btn-block">تعديل
                                    المركز</button>
                                    <p id="uploadingText"
