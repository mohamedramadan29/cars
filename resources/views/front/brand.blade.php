        ...
        <div class="PageCard">
            <div class="card-body" style="padding:0px;">
                <div class="card-text rent">
                    <div class="brand-bg clearfix2" style="linear-gradient(rgba(206 0 20 / 71%), rgba(206 0 20 / 71%)), url(asset('assets/front/uploads/bg.jpg');">
                        <div class="rgt brand-col2">
                            <center>
                                <img class="brand-img" src="{{asset('assets/uploads/Marks/'.$brand['logo'])}}"> </center>
                        </div>
                        <div class="rgt brand-col6">
                            <h4 class="brand-title">{{$brand['name']}}</h4>
                            <div class="clr"></div>
                            <p class="display-brand brand-desc">{{$brand['description']}}</p>
                            <div class="clr"></div>
                            <div class="display-brand">
                                @foreach($brand['Models'] as $model)
                                    <div class="rgt brandmodel">
                                        <div class="card-body"><a href="#" class="card-title">{{$model['name']}}</a></div>
                                    </div>
                                @endforeach
                            </div>
                        </div>
