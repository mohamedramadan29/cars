...
<div id="HomePage">
    <a href="{{url('privacy')}}" class="rgt card pages-card" style="border:1px dashed var(--main-color);">
        <div class="card-body">
            <center>
                <i class="far fa-lightbulb fa-2x" style="color:var(--main-color);"></i>
                <div class="clr"></div>
                <h5 class="card-title" style="color:var(--main-color);">شروط الاستخدام </h5>
            </center>
        </div>
    </a>
    <a href="{{url('terms')}}" class="rgt card pages-card">
        <div class="card-body">
            <center>
                <i class="fas fa-user-shield fa-2x"></i>
                <div class="clr"></div>
                <h5 class="card-title"> الخصوصية </h5>
            </center>
        </div>
    </a>
    <div class="clr"></div><br>
    <div class="card">
        <div class="card-body">
            <h5 class="card-title" style="font-weight:bold;">شروط الاستخدام</h5>
            <div class="card-text">
