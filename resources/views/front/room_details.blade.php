                                ...
                                <div class="col-md-8">
                                    <div class="card-body">
                                        ...
                                        <div class="card-text">
                                            ...
                                            <div class="rgt ico-car"><i
                                                        class="fas fa-calendar-alt"></i> {{$adv['c_years']}}</div>
                                        </div>
                                        <div class="clr"></div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-text ico-SRinfo">
                                <div class="SRINFO"><i class="fas fa-car-side"></i> حالة السيارات :
                                    <span class="btn gradient-btn btn-sm"
                                          style="padding:6px 36px;"> {{$room['car_status']}} </span>
                                </div>
                                <div class="SRINFO"><i class="fas fa-map"></i> {{$room['address']}} </div>
                                <div class="SRINFO"><a href="#" class="btn btn-success btn-sm"> {{$room['phone']}} <i
                                                class="fas fa-phone-volume" style="color:white;"></i></a></div>
                                <div class="SRINFO"><a href="#" class="btn btn-primary btn-sm"> {{$room['phone2']}} <i
                                                class="fas fa-phone-volume" style="color:white;"></i></a>
                                </div>@if($room['phone'] != '')
                            ...
                            <div>
                                @if(!empty($room['website']))
                                    <div class="SRINFO"><a href="{{$room['website']}}" class="btn btn-primary btn-sm"
                                                           ...
                                                           target="_blank"><i
                                                    class="fas fa-globe"></i> {{$room['website']}} </a></div>
                                @endif
                                @if(!empty($room['facebook_link']))
                                    <div class="SRINFO"><a href="{{$room['facebook_link']}}"
                                                           class="btn btn-light btn-sm" target="_blank"><i
                                                    class="fab fa-facebook" style="color:#0b70ea;"></i> رابط الصفحة </a>
                                    </div>
                                @endif
                                @if(!empty($room['twitter_link']))
                                    <div class="SRINFO"><a href="{{$room['twitter_link']}}" class="btn btn-light btn-sm"
                                                           target="_blank"><i class="fab fa-twitter"
                                                                              style="color:#4fdbf7;"></i> رابط الصفحة
                                        </a></div>
                                @endif
                                    @if(!empty($room['instagram_link']))
                                        <div class="SRINFO"><a href="{{$room['instagram_link']}}" class="btn btn-light btn-sm" target="_blank"><i class="fab fa-instagram" style="color:#E73E53;"></i> رابط الصفحة </a></div>
                                    @endif
                            </div>
                            <div class="clr"></div><br><br>
                            <h5 class="card-title CC3"><i class="fas fa-hashtag"></i> الموقع على الخريطة </h5>
                            <div class="clr"></div>
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14948548.954898184!2d36.05427085182272!3d23.834663897796574!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x15e7b33fe7952a41%3A0x5960504bc21ab69b!2sSaudi%20Arabia!5e0!3m2!1sen!2sma!4v1578447115480!5m2!1sen!2sma" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
