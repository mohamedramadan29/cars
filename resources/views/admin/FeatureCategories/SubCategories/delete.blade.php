<div class="modal fade" id="delete_plan_{{$plan['id']}}" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{url('admin/feature-categories/plans/delete/'.$plan['id'])}}" method="post">
                @csrf
                <div class="modal-body">
                    <label for="">  اسم الخطة   </label>
                    <input type="text" name="name" class="form-control" disabled readonly value="{{$plan['title']}}">
                </div>
