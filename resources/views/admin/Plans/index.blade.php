                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center gap-1">
                            <h4 class="card-title flex-grow-1">  العضويات المميزة   </h4>
                            <a href="{{url('admin/plan/add')}}" class="btn btn-sm btn-primary">
                               اضافة خطة جديدة
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-2">
                                                    <a href="{{url('admin/plan/update/'.$plan['id'])}}" type="button" class="btn btn-soft-primary btn-sm">
