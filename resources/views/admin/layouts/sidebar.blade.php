        ...
        <ul class="navbar-nav" id="navbar-nav">
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="sidebaradvs">
                    <ul class="nav sub-navbar-nav">
                        ...
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ url('admin/advertisements/under_review') }}"> اعلانات تحت
                                المراجعه </a>
                        </li>
                        <li class="sub-nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link menu-arrow" href="#sidebarcountry" data-bs-toggle="collapse" role="button"
                    ...
                    <span class="nav-text"> المحافظات والمناطق </span>
                </a>
                <div class="collapse" id="sidebarcountry">
                    <ul class="nav sub-navbar-nav">
                        <li class="sub-nav-item">
                            <a class="sub-nav-link" href="{{ url('admin/countries') }}"> المحافظات والمناطق </a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/banners') }}">
                    ...
                    <span class="nav-text">  البنرات الرئيسية  </span>
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ url('admin/sliders') }}">
                    ...
                    <span class="nav-text">  البنرات المتحركة  </span>
                </a>
            </li>
