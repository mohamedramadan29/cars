...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="container-xxl">
            <form method="post" action="{{url('admin/showroom/update/'.$room['id'])}}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" id="address" class="form-control" name="address"
                                                   value="{{ $room->getTranslation('address','ar')}}">
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" id="address_en" class="form-control" name="address_en"
                                                   value="{{ $room->getTranslation('address','en')}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="desc" class="form-control">{{ $room->getTranslation('desc','ar')}}</textarea>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="desc_en" class="form-control">{{ $room->getTranslation('desc','en')}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" id="work_time" class="form-control" name="work_time"
                                                   value="{{$room->getTranslation('work_time','ar')}}">
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input required type="text" id="work_time_en" class="form-control" name="work_time_en"
                                                   value="{{ $room->getTranslation('work_time','en')}}">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> لوجو المعرض   </h4>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <img class="img-thumbnail"
                                         src="{{asset('assets/uploads/showRooms/'.$room['logo'])}}" width="60"
                                         height="60px" alt="">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-3 bg-light mb-3 rounded">
                            <div class="row justify-content-end g-2">
                                ...
                                <div class="col-lg-2">
                                    <a href="{{url('admin/showrooms')}}" class="btn btn-primary w-100"> رجوع </a>
                                </div>
