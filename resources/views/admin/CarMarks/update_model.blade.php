<div class="modal fade" id="edit_model_{{$model['id']}}" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{url('admin/car_mark/models/update/'.$model['id'])}}" method="post">
                @csrf
                <div class="modal-body">
                    ...
                    <div>
                        ...
                        <input type="text" name="model_name" class="form-control" value="{{$model->getTranslation('name','ar')}}">
                    </div>
                    <br>
                    <div>
                        <label for="">  اسم الموديل باللغة الانجليزية  </label>
                        <input type="text" name="model_name_en" class="form-control" value="{{$model->getTranslation('name','en')}}">
                    </div>
